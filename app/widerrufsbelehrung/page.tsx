...
export const metadata = {
  ...
  alternates: { canonical: absoluteUrl("/widerrufsbelehrung") },
};
  ...
  return (
    <article className="legal-page">
      ...
      <div className="legal-content">
        ...
        <p>Um dein Widerrufsrecht auszuüben, musst du uns (Venus Management GbR, Ulmenweg 15, 51766 Engelskirchen, info@followerbase.de) mittels einer eindeutigen Erklärung (z. B. ein mit der Post versandter Brief oder E-Mail) über deinen Entschluss, diesen Vertrag zu widerrufen, informieren.</p>
