  ...
  return (
    <article className="legal-page">
      ...
      <div className="legal-content">
        ...
        <p>Es gelten die zum Zeitpunkt der Bestellung angegebenen Preise inkl. der gesetzlichen Mehrwertsteuer. Die Zahlung erfolgt über PayPal oder per Überweisung. Die Lieferung bzw. Ausführung der bestellten Leistung erfolgt nach Zahlungseingang.</p>

        <h2>§ 4 Leistung, Lieferzeit</h2>
        <p>Wir erbringen digitale Dienstleistungen gemäß Produktbeschreibung (z. B. Follower, Likes, Views oder vergleichbare Leistungen für soziale Netzwerke wie Instagram, TikTok, YouTube). Die angegebene Lieferzeit ist unverbindlich, sofern nicht ausdrücklich anders vereinbart.</p>
