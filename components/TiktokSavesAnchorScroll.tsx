...
/** Nur auf /product/tiktok-saves-kaufen: Anker-Scroll und FAQ aria-expanded. */
export function TiktokSavesAnchorScroll() {
  useEffect(() => {
    const page = document.querySelector(".tiktok-saves-page");
    ...
    page.querySelectorAll("details.fbtsaves-faq-item").forEach((node) => {
