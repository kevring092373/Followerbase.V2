...
/** Nur auf /product/tiktok-follower-tuerkisch-kaufen: Anker-Scroll und FAQ aria-expanded. */
export function TiktokFollowerTuerkischAnchorScroll() {
  useEffect(() => {
    const page = document.querySelector(".tiktok-follower-tuerkisch-page");
    ...
    page.querySelectorAll("details.fbtt-faq-item").forEach((node) => {
