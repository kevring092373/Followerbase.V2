...
/** Nur auf /product/instagram-follower-deutsch-kaufen: Anker-Scroll und FAQ aria-expanded. */
export function InstagramFollowerDeutschAnchorScroll() {
  useEffect(() => {
    const page = document.querySelector(".instagram-follower-deutsch-page");
    ...
    page.querySelectorAll("details.fbdef-faq-item").forEach((node) => {
