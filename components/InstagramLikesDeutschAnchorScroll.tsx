...
/** Nur auf /product/instagram-likes-deutsch-kaufen: Anker-Scroll und FAQ aria-expanded. */
export function InstagramLikesDeutschAnchorScroll() {
  useEffect(() => {
    const page = document.querySelector(".instagram-likes-deutsch-page");
    ...
    page.querySelectorAll("details.fbdl-faq-item").forEach((node) => {
