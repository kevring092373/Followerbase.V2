...
/** Nur auf /product/instagram-follower-tuerkisch-kaufen: Anker-Scroll und FAQ aria-expanded. */
export function InstagramFollowerTuerkischAnchorScroll() {
  useEffect(() => {
    const page = document.querySelector(".instagram-follower-tuerkisch-page");
    ...
    page.querySelectorAll("details.fbtr-faq-item").forEach((node) => {
