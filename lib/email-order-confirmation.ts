...
<body style="font-family: system-ui, sans-serif; line-height: 1.6; color: #1e293b; max-width: 560px; margin: 0 auto; padding: 32px;">
  ...
  <p style="font-size: 1.25rem; font-weight: 700; color: #8a55ee; margin: 0 0 8px 0;">Bestellnummer: ${escapeHtml(order.orderNumber)}</p>
...
<body style="font-family: system-ui, sans-serif; line-height: 1.5; color: #1e293b; max-width: 560px; margin: 0 auto; padding: 24px;">
  ...
  <p style="margin-top: 16px;"><a href="${escapeHtml(adminOrdersUrl)}" style="color: #8a55ee;">Bestellungen im Admin öffnen</a></p>
</body>
</html>`;
}
